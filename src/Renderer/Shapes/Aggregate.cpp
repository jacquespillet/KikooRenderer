...
namespace OfflineRenderer {
    Aggregate::Aggregate(glm::vec3 position, Material* material) {
    ...
    glm::vec3 Aggregate::GetPosition(double time) {
        return this->position;
    }


    double Aggregate::HitRay(KikooRenderer::Geometry::Ray ray, double tMin, double tMax, Point& hitPoint) {
