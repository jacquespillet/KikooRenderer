...
DeferredRenderer::DeferredRenderer(Scene* scene) : Renderer(scene) {
    GETGL
    SetFramebuffers();
...
void DeferredRenderer::AddPostEffect(PostProcess* postProcess) {
    postProcessor.AddProcess(postProcess);
    scene->triggerRefresh = true;
}
void DeferredRenderer::RemovePostEffect(PostProcess* postProcess) {
    postProcessor.RemoveProcess(postProcess);
    scene->triggerRefresh = true;
}


void DeferredRenderer::SetFramebuffers() {
...
void DeferredRenderer::SetGammaCorrection(bool value) {
...
void DeferredRenderer::SetMSAA(bool value) {
    useMSAA = value;
